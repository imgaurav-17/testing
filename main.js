...
const botstart = async (ctx) =>{
    try{
        ...
        if (!(admin.length)){
            let botData = {admin:'@inferno_scorpion',ref:1,mini:2,max:4,paycha:'@Username',botstat:'Active',withstat:'On',subid:'Not Set',mid:'NOT SET',mkey:'NOT SET',comment:'NOT SET',tax:0,channels:["@qwikdeals"]}
